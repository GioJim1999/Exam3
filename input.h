...
//PreCondition: input (cstring) 
//PostCondition: returns a string with all the characters lower case
string convertLower(const char* input)
{
	string x = "";
	if (*(input) == '\0')
	{
...
//PreCondition: input (cstring) 
//PostCondition: returns a string with all the characters upper case
string convertUpper(const char* input)
{
	string x = "";
	if (*(input) == '\0')
	{
...
//Postcondition: returns the string with the first letter uppercased.
...
//Precondition: input (string)
//Postcondition: returns the string with the first letter lowercased.
